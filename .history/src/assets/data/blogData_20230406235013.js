...
const blogData = [
  {
    ...
    imgUrl: img01,
    description:
      " Tập làm quen với thao tác trên xe.
      Lái xe với tốc độ vừa phải.
      Giữ khoảng cách an toàn khi điều khiển xe ô tô
      Quan sát gương chiếu hậu.
      Kinh nghiệm quay đầu xe hơi an toàn.
      Giữ tâm lý vững vàng.
      Thắt dây an toàn và không uống rượu bia khi lái xe.
      Quan sát biển báo.",
    quote:
