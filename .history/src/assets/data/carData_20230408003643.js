...
import img08 from "../all-images/cars-img/rolls-royce-cullinan-0518-019.jpg";
...
const carData = [
...

  {
    ...
    automatic: "Tự động",
    description:
      " Audi Fiesta là một mẫu xe sedan trong phân khúc xe hạng B. Đây là một phân khúc phù hợp với nhiều đối tượng thị trường và khách hàng khác nhau nên được rất nhiều các hãng xe tham gia đặc biệt là các hãng xe tầm trung. Ford là một hãng xe lớn của Mỹ được thành lập từ rất sớm và là một trong những hãng xe vừa sản xuất xe vừa cho ra mắt các trang bị tiện nghi của xe dùng chung cho nhiều hãng xe nổi tiếng khác chính vì thế những chiếc xe Ford được mệnh danh là rất bền bỉ và có khả năng vận hành vượt trội. ",
  },

  {
    ...
    price: 4,
    speed: "120km/h",
    gps: "Có tích hợp GoogleMap",
    seatType: "Có sấy ghế",
    automatic: "Tự động",
    description:
      " Rolls Royce Colorado là một mẫu xe sedan trong phân khúc xe hạng B. Đây là một phân khúc phù hợp với nhiều đối tượng thị trường và khách hàng khác nhau nên được rất nhiều các hãng xe tham gia đặc biệt là các hãng xe tầm trung. Ford là một hãng xe lớn của Mỹ được thành lập từ rất sớm và là một trong những hãng xe vừa sản xuất xe vừa cho ra mắt các trang bị tiện nghi của xe dùng chung cho nhiều hãng xe nổi tiếng khác chính vì thế những chiếc xe Ford được mệnh danh là rất bền bỉ và có khả năng vận hành vượt trội.",
  },
