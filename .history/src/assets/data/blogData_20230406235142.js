...
const blogData = [
  {
    ...
    imgUrl: img01,
    description:
      " Khi mới lái xe, bạn cần tránh sử dụng những chiếc xe động cơ dung tích lớn, công suất cao, những chiếc xe sang trọng, đắt tiền. Những chiếc xe này có sức mạnh lớn, khả năng tăng tốc nhanh. Tuy nhiên với lái mới chưa đủ kinh nghiệm để xử lý những tình huống xảy ra quá nhanh.
      ",
    quote:
